...
def add_task (*,
    ...
    error_handling_input(tasks = tasks, tasks_input = task_input, day = day, full = False)
    
    normalized: set = valid_task(task_input, vers_add= True) 
    if not normalized:
        raise ValueError
...
def remove_task (*,
    ...
    error_handling_input(tasks= tasks, tasks_input= task_input, day = day, full = True)
    normalized: set = valid_task(task_input, vers_add= False)
    if not normalized:
...
def set_task_status(
    *,
    ...
    error_handling_input(tasks= tasks, tasks_input = tasks_input, day = day, full = True)
